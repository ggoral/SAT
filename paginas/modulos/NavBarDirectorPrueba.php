        ...
        <div class="container">
            ...
            <div class="nav-collapse collapse">
                <ul class="nav pull-right">
                    ...
                    <li><a><span class="muted"><b>Logueado como: </b></span><span class="text-error">director</span></a></li>
                    ...
                    <li class="active"><a href="/SAT/paginas/reportes/reportes.php">Reporte</a></li>
                </ul>
            </div>
        </div>
    </div>