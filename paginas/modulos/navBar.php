                    ...
                    <div class="container">
                        ...
                        <div class="nav-collapse collapse">
                            <ul class="nav pull-right"><li class="divider-vertical"></li>
                                ...
                                <li><a href="/SAT/paginas/pacientes/listar.php">Pacientes</a></li><li class="divider-vertical"></li>
                                <li><a href="/SAT/paginas/medicos/listar.php">Medicos</a></li><li class="divider-vertical"></li>
